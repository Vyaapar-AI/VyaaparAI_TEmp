...
export default function TermsAndConditionsPage() {
  ...
  const content = (process.env.NEXT_PUBLIC_TERMS_AND_CONDITIONS || 'Content not available. Please configure the environment variables.').replace(/\[Store Name\]/g, storeName);
