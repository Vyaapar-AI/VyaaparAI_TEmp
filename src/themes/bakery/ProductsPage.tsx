...
export default async function BakeryProductsPage() {
      ...
      <section className="bg-secondary/50 border-b">
        <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
                From flaky croissants to decadent cakes, find your new favorite. Each item is baked fresh daily with the finest local ingredients.
            </p>
        </div>
      </section>
