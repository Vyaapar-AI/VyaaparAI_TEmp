...
export default async function FoodCourtProductsPage() {
    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="bg-secondary/50 border-b">
        <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="mt-4 text-4xl font-bold tracking-tight uppercase text-foreground sm:text-5xl font-headline">
                Full Menu
            </h1>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
                Can't decide? Browse our full menu of fan-favorite fast food. Your next craving is just a click away.
            </p>
        </div>
      </section>
