...
export default async function HomeDecorProductsPage() {
    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="bg-secondary/50 border-b">
        <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 text-center">
            <Sofa className="mx-auto h-12 w-12 text-primary" />
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
                Explore our full range of decor, furniture, and lighting to find the perfect pieces for your space.
            </p>
        </div>
      </section>
