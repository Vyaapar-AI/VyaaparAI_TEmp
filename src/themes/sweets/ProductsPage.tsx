...
export default async function SweetsProductsPage() {
      ...
      <section className="bg-secondary border-b">
        <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="mt-4 text-4xl font-bold tracking-tight text-foreground sm:text-5xl font-headline">
                Our Entire Sweet Collection
            </h1>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
                Dive into our world of vegan and gluten-free treats. There's a sweet delight waiting for everyone.
            </p>
        </div>
      </section>
